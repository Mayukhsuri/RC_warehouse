<div class="column60">
    <div class="contentblock">
        <?php
            ...
            $sql = "SELECT *, CAST(Active AS int) AS newst FROM warehouses WHERE $activeQuery ORDER BY Name ASC";
            ...
            if($row_count >= 1) {
                ...
                while($row = sqlsrv_fetch_array($result)) {
                    ...
                    echo '<tr onclick="location.href=\'index.php?pid=69&rec=' . $row['ID'] . '\'"' . $classname . '>' . PHP_EOL;
