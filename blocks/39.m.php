<div class="column80">
    <div class="contentblock" style="padding-bottom: 0;">
        <?php
            ...
            $sql = "SELECT FirstName, LastName FROM users WHERE EmployeeID=$tempeeid";
            $temprow = sqlsrv_fetch_array(sqlsrv_query($connection, $sql));
            ...
            if($row['BoxCount'] > 0) {
                ...
                if($tempeeid == $userid && !isset($_GET['cancel'])) {
                    echo '<div class="buttonleft">';
                    echo '<a href="index.php?pid=39&cancel=0&rid=' . $requestid . '">Cancel Request</a>';
                    echo '</div>';
                }
