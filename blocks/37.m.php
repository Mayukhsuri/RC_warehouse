<div class="column80">
    <div class="contentblock">
        <?php
            ...
            echo '<div class="buttonleft"><a href="index.php?pid=37&box=' . $boxid . '&requested=1&prop=' . $prop . '&rt=' . $rt . '&start=' . $start . '&end=' . $end . '">Request Box</a><a href="index.php?pid=36&prop=' . $prop . '&rt=' . $rt . '&start=' . $start . '&end=' . $end . '">Back to List</a></div>' . PHP_EOL;
